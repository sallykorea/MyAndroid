...
public class Main4Activity extends AppCompatActivity
    ...
    public void updateListView(String data){
        ...
        try {
            ...
            //listview를 가장 아래 쪽으로 스크롤 하기(모델의 개수를 전달하면 된다.)
    ...
    public void onClick(View v) {
        ...
        map.put("name", name);
        map.put("addr", addr);
        String urlAddr="http://192.168.0.35:8865/spring05/android/member/insert.do";
        Util.sendPostRequest(REQUEST_INSERT, urlAddr, map, Main4Activity.this );
        //키보드 숨기기
